    ...
    renderLog() {
        ...
        switch(this.props.data.field) {
            ...
            case "start_time":
                ...
                const nv =  this.props.data.new_value ? <span><span className="font-weight-bold">{moment.utc(this.props.data.new_value).tz(this.props.lead.details.timezone).format("MMM D")}</span>, {moment.utc(this.props.data.new_value).tz(this.props.lead.details.timezone).format("h:mm a")} {this.props.lead.details.timezone_short}</span> : localization.noTime
                result =
