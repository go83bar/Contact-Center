                ...
                <MDBRotatingCard flipped={this.state.flipped} className="text-center h-100 w-100" style={{margin: "0 auto", marginTop: "10%", width: "500px"}}>
                    <MDBCard className="face front" narrow >
                        ...
                        <MDBCardBody cascade className='text-center'>
                            <div className={"text-left"}><MDBInput label={localization.frontPlaceholder} outline icon="envelope" className={"text-left"} onChange={(e) => this.setEmailValue(e)} /></div>
                    ...
                    <MDBCard className="face back" narrow >
                        ...
                        <MDBCardBody cascade className='text-center'>
                            <div className={"text-left"}><MDBInput label={localization.backPlaceholder} outline icon="lock" className={"text-left"} onChange={(e) => this.setPinValue(e)} /></div>
